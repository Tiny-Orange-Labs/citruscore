...
/**
     ...
     * SPDX-License-Identifier: BSD-3-Clause
     */
function Rt(t,e){const o=dt({waitUntilFirstUpdate:!1},e);return(e,i)=>{const{update:r}=e;if(t in e){const s=t;e.update=function(t){if(t.has(s)){const e=t.get(s),r=this[s];e!==r&&(o.waitUntilFirstUpdate&&!this.hasUpdated||this[i](e,r))}r.call(this,t)}}}}var Vt=t=>e=>"function"==typeof e?((t,e)=>(customElements.define(t,e),e))(t,e):((t,e)=>{const{kind:o,elements:i}=e;return{kind:o,elements:i,finisher(e){customElements.define(t,e)}}})(t,e),Dt=(t,e)=>"method"===e.kind&&e.descriptor&&!("value"in e.descriptor)?ct(dt({},e),{finisher(o){o.createProperty(e.key,t)}}):{kind:"field",key:Symbol(),placement:"own",descriptor:{},originalKey:e.key,initializer(){"function"==typeof e.initializer&&(this[e.key]=e.initializer.call(this))},finisher(o){o.createProperty(e.key,t)}};function Ft(t){return(e,o)=>void 0!==o?((t,e,o)=>{e.constructor.createProperty(o,t)})(t,e,o):Dt(t,e)}function jt(t){return Ft(ct(dt({},t),{state:!0}))}var It;function qt(t,e){return(({finisher:t,descriptor:e})=>(o,i)=>{var r;if(void 0===i){const i=null!==(r=o.originalKey)&&void 0!==r?r:o.key,s=null!=e?{kind:"method",placement:"prototype",key:i,descriptor:e(o.key)}:ct(dt({},o),{key:i});return null!=t&&(s.finisher=function(e){t(e,i)}),s}{const r=o.constructor;void 0!==e&&Object.defineProperty(o,i,e(i)),null==t||t(r,i)}})({descriptor:o=>{const i={get(){var e,o;return null!==(o=null===(e=this.renderRoot)||void 0===e?void 0:e.querySelector(t))&&void 0!==o?o:null},enumerable:!0,configurable:!0};if(e){const e="symbol"==typeof o?Symbol():"__"+o;i.get=function(){var o,i;return void 0===this[e]&&(this[e]=null!==(i=null===(o=this.renderRoot)||void 0===o?void 0:o.querySelector(t))&&void 0!==i?i:null),this[e]}}return i}})}null===(It=window.HTMLSlotElement)||void 0===It||It.prototype.assignedElements;var Wt=class extends G{emit(t,e){const o=new CustomEvent(t,dt({bubbles:!0,cancelable:!1,composed:!0,detail:{}},e));return this.dispatchEvent(o),o}};ht([Ft()],Wt.prototype,"dir",2),ht([Ft()],Wt.prototype,"lang",2);
/**
     * @license
     * Copyright 2017 Google LLC
     * SPDX-License-Identifier: BSD-3-Clause
...
`,ze=Object.assign(document.createElement("div"),{className:"sl-toast-stack"}),Pe=class extends Wt{constructor(){super(...arguments),this.hasSlotController=new Pt(this,"icon","suffix"),this.localize=new zt(this),this.open=!1,this.closable=!1,this.variant="primary",this.duration=1/0}firstUpdated(){this.base.hidden=!this.open}async show(){if(!this.open)return this.open=!0,ye(this,"sl-after-show")}async hide(){if(this.open)return this.open=!1,ye(this,"sl-after-hide")}async toast(){return new Promise((t=>{null===ze.parentElement&&document.body.append(ze),ze.appendChild(this),requestAnimationFrame((()=>{this.clientWidth,this.show()})),this.addEventListener("sl-after-hide",(()=>{ze.removeChild(this),t(),null===ze.querySelector("sl-alert")&&ze.remove()}),{once:!0})}))}restartAutoHide(){clearTimeout(this.autoHideTimeout),this.open&&this.duration<1/0&&(this.autoHideTimeout=window.setTimeout((()=>this.hide()),this.duration))}handleCloseClick(){this.hide()}handleMouseMove(){this.restartAutoHide()}async handleOpenChange(){if(this.open){this.emit("sl-show"),this.duration<1/0&&this.restartAutoHide(),await we(this.base),this.base.hidden=!1;const{keyframes:t,options:e}=Ce(this,"alert.show",{dir:this.localize.dir()});await _e(this.base,t,e),this.emit("sl-after-show")}else{this.emit("sl-hide"),clearTimeout(this.autoHideTimeout),await we(this.base);const{keyframes:t,options:e}=Ce(this,"alert.hide",{dir:this.localize.dir()});await _e(this.base,t,e),this.base.hidden=!0,this.emit("sl-after-hide")}}handleDurationChange(){this.restartAutoHide()}render(){return O`
      <div
        part="base"
    ...
    `}};Pe.styles=Se,ht([qt('[part~="base"]')],Pe.prototype,"base",2),ht([Ft({type:Boolean,reflect:!0})],Pe.prototype,"open",2),ht([Ft({type:Boolean,reflect:!0})],Pe.prototype,"closable",2),ht([Ft({reflect:!0})],Pe.prototype,"variant",2),ht([Ft({type:Number})],Pe.prototype,"duration",2),ht([Rt("open",{waitUntilFirstUpdate:!0})],Pe.prototype,"handleOpenChange",1),ht([Rt("duration")],Pe.prototype,"handleDurationChange",1),Pe=ht([Vt("sl-alert")],Pe),Ee("alert.show",{keyframes:[{opacity:0,scale:.8},{opacity:1,scale:1}],options:{duration:250,easing:"ease"}}),Ee("alert.hide",{keyframes:[{opacity:1,scale:1},{opacity:0,scale:.8}],options:{duration:250,easing:"ease"}});var Ue=l`
  ${tt}
...
/**
     ...
     * SPDX-License-Identifier: BSD-3-Clause
     */
let Ko=t=>{return"string"!=typeof(e=t)&&"strTag"in e?((t,e,o)=>{let i=t[0];for(let r=1;r<t.length;r++)i+=e[o?o[r-1]:r-1],i+=t[r];return i})(t.strings,t.values):t;var e};let Jo=class extends To{constructor(){super()}createRenderRoot(){return this}async#t(t,e){const o=await fetch("/auth",{method:"POST",mode:"cors",cache:"no-cache",credentials:"same-origin",headers:{"Content-Type":"application/json"},body:JSON.stringify({data:{username:t,password:e},client:Ro})});await o.json()}async#e(){const t=(this.querySelector("#username")?.value||"").toLocaleLowerCase().trim(),e=this.querySelector("#password")?.value||"";if(""!==t&&""!==e)return this.#t(t,e);!function(t,e,o){const i=Object.assign(document.createElement("sl-alert"),{variant:t,closable:!0,duration:3e3,innerHTML:`\n          <sl-icon name="${Vo[t]}" slot="icon"></sl-icon>\n          <strong>${e}</strong><br />${o}\n        `});document.body.append(i),i.toast()}("warning",Ko("Credentials are Empty"),Ko("Please fill in Username and Password"))}render(){return po`<div></div>
            ...
            </div>`}};Jo=function(t,e,o,i){var r,s=arguments.length,n=s<3?e:null===i?i=Object.getOwnPropertyDescriptor(e,o):i;if("object"==typeof Reflect&&"function"==typeof Reflect.decorate)n=Reflect.decorate(t,e,o,i);else for(var l=t.length-1;l>=0;l--)(r=t[l])&&(n=(s<3?r(n):s>3?r(e,o,n):r(e,o))||n);return s>3&&n&&Object.defineProperty(e,o,n),n}([Io(),(t=>e=>"function"==typeof e?((t,e)=>(customElements.define(t,e),e))(t,e):((t,e)=>{const{kind:o,elements:i}=e;return{kind:o,elements:i,finisher(e){customElements.define(t,e)}}})(t,e))("login-layout")],Jo),Gt("/assets/shoelace")}()}();
