...
let ViewLayout = class ViewLayout extends s$1 {
    ...
    #renderRows({ rows }) {
        return [...new Array(rows)].map(function () {
            return y `<div class="view-row"></div>`;
        });
    }
    render() {
