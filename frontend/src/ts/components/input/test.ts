...
describe('project-input', () => {
    it('Empty value', async () => {
        const el: any = await fixture(html`<project-input label="preis" placeholder="0.0"></project-input>`);
    ...
    it('Check optional span', async () => {
        const el: any = await fixture(
            html`<project-input prefix="€" label="preis" optional="true" placeholder="0.0"></project-input>`,
        );
    ...
    it('passes the a11y audit', async () => {
        const el: any = await fixture(html`<project-input prefix="€" label="preis" placeholder="0.0"></project-input>`);
